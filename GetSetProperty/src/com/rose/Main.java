...
public class Main
{
	 ...
	 */
	public static void getProperty1(Bean bean, String propertyName) throws IntrospectionException,
	 ...
	 * @throws InvocationTargetException
	 */
	public static void getProperty(Bean bean, String propertyName) throws IntrospectionException,
			IllegalAccessException, IllegalArgumentException,
			InvocationTargetException
	{
