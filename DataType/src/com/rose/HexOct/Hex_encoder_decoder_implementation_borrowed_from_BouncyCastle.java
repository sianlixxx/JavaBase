...
public class Hex_encoder_decoder_implementation_borrowed_from_BouncyCastle
{
	/**
	 ...
	 */
	private Hex_encoder_decoder_implementation_borrowed_from_BouncyCastle()
	{
		// Nothing to do ...
	}
	 ...
	 * 
	 * @param data
	 *            The input data to be HEX encoded
	 * @param off
	 *            Initiak offset
	 * @param length
	 *            Initial length of the input data array
	 * @param out
	 *            The {@link OutputStream} instance holding the encoded input
	 *            data.
	 * @return the number of bytes produced.
	 * @throws IOException
	 *             If encoding fails.
	 */
	public static int encode(final byte[] data, final int off,
			final int length, final OutputStream out) throws IOException
	{
	...
	/**
	 * Indicates whether a given character should be ignored during
	 * en-/decoding.
	 * 
	 * @param c
	 *            The character at question.
	 ...
	 *            Initial length
	 * @param out
	 *            The {@link OutputStream} instance
	 * @return the number of bytes produced.
	 * @throws IOException
	 *             If encoding failed.
	 */
	public static int decode(final byte[] data, final int off,
			final int length, final OutputStream out) throws IOException
	{
		byte b1, b2;
		int outLen = 0;
	...
	/**
	 * Decodes the Hex encoded String data writing it to the given output
	 ...
	 *             If encoding failed.
	 */
	public static int decode(final String data, final OutputStream out)
			throws IOException
	{
		byte b1, b2;
		int length = 0;
