...
public class converting_a_long_into_a_human_readable_string
{
	...
	private converting_a_long_into_a_human_readable_string(long milliseconds,
			int round)
	{
		this.rounding = round;
	...
	private converting_a_long_into_a_human_readable_string(long milliseconds)
	{
		this(
				milliseconds,
				converting_a_long_into_a_human_readable_string.ROUND_TO_MILLISECOND);
	}
	...
	/**
	 * add a converting_a_long_into_a_human_readable_string
	 * 
	 * 
	 * @param t
	 */
	public void add(converting_a_long_into_a_human_readable_string t)
	{
		days += t.days;
		hours += t.hours;
		minutes += t.minutes;
	 ...
	 * @param t
	 */
	public void getDays(converting_a_long_into_a_human_readable_string t)
	{
	 ...
	 * @param t
	 */
	public void getHours(converting_a_long_into_a_human_readable_string t)
	{
	 ...
	 * @param t
	 */
	public void getMinutes(converting_a_long_into_a_human_readable_string t)
	{
	 ...
	 * @param t
	 */
	public void getSeconds(converting_a_long_into_a_human_readable_string t)
	{
	 ...
	 * @param t
	 */
	public void getTime(converting_a_long_into_a_human_readable_string t)
	{
		t.getTime();
	}
	...
	public String format(int round)
	{
		...
		if (DEBUG)
		{
			System.err.println("-->time: " + time + ", round: " + round
					+ ", micro: " + micro + ",remainder:" + remainder);
		...
		{
			return formatDays(true) + formatHours(true) + formatMinutes(true)
					+ formatSeconds(false);
		}
		...
		{
			return formatDays(true) + formatHours(true) + formatMinutes(true)
					+ formatSeconds(true) + (micro ? time : milliseconds)
					+ " ms";
		}
		}
	...
	{
		converting_a_long_into_a_human_readable_string f = new converting_a_long_into_a_human_readable_string(
				t, round);
	...
	public static String format(String format, long time)
	{
		...
		return f.parse(format, f.getDays(), f.getHours(), f.getMinutes(),
	 ...
	 * parse
	 */
	private String parse(String format, long day, long hour, long minute,
			long second, long millis)
	{
		String s = "";
		int start = 0;
		...
		for (int c = 0; c < len; c++)
		{
			...
			case 'd':
				while (++c < len
						&& (format.charAt(c) == 'd' || format.charAt(c) == 'D'))
					;
			...
			case 'H':
				while (++c < len
						&& (format.charAt(c) == 'h' || format.charAt(c) == 'H'))
					;
			...
			case 'M':
				while (++c < len
						&& (format.charAt(c) == 'm' || format.charAt(c) == 'M'))
					;
			...
			case 'S':
				while (++c < len
						&& (format.charAt(c) == 's' || format.charAt(c) == 'S'))
					;
			...
			case 'Z':
				while (++c < len
						&& (format.charAt(c) == 'z' || format.charAt(c) == 'Z'))
					;
	...
	public static void main(String args[])
	{
		...
		System.out.println(converting_a_long_into_a_human_readable_string
				.format(FORMAT, 1000));
		System.out.println("ONE SECOND: "
				+ converting_a_long_into_a_human_readable_string.ONE_SECOND);
		System.out.println("ONE MINUTE: "
				+ converting_a_long_into_a_human_readable_string.ONE_MINUTE);
		System.out.println("ONE HOUR:   "
				+ converting_a_long_into_a_human_readable_string.ONE_HOUR);
		System.out.println("ONE DAY:    "
				+ converting_a_long_into_a_human_readable_string.ONE_DAY);

		for (int c = 0; c <= 5; c++)
		{
			System.out.println("Round to: " + c);
			System.out.println("Time: "
					+ converting_a_long_into_a_human_readable_string.valueOf(
							Long.MAX_VALUE, c));
			System.out.println("Time: "
					+ converting_a_long_into_a_human_readable_string.valueOf(
							1236371400, c));
			System.out.println("Time: "
					+ converting_a_long_into_a_human_readable_string.format(
							FORMAT, 1236371400));
			System.out.println("Time: "
					+ converting_a_long_into_a_human_readable_string.valueOf(
							123613700, c));
			...
			System.out.println("Time: "
					+ converting_a_long_into_a_human_readable_string.valueOf(
							ONE_HOUR + ONE_DAY + (ONE_MINUTE * 2), c));
			System.out.println("Time: "
					+ converting_a_long_into_a_human_readable_string.format(
							FORMAT, ONE_HOUR + ONE_DAY + (ONE_MINUTE * 2)));
		}
	}
